...
{
    public partial class CategoryMasterConfiguration : IEntityTypeConfiguration<CategoryMaster>
    {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<CategoryMaster> entity);
    }
}
