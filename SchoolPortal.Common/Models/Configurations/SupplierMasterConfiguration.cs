...
{
    public partial class SupplierMasterConfiguration : IEntityTypeConfiguration<SupplierMaster>
    {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<SupplierMaster> entity);
    }
}
